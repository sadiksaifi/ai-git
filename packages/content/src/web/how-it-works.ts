  ...
  steps: [
    {
      ...
      description:
        "One command. Works with npm, bun, pnpm, yarn, or Homebrew.",
    },
    {
      step: 2,
      title: "Configure",
      ...
      description:
        "Pick your AI provider. Set your model. Keys go straight to your keychain.",
    },
    {
      step: 3,
      title: "Commit",
      command: "ai-git",
      description:
        "Stage changes, generate a message, review it, commit. That's it.",
    },
